...
class TestDataCreator {
  ...
  static createTestData() {
    const orgId1 = mongoose.Types.ObjectId('578df3efb618f5141202a196');
    const orgId2 = mongoose.Types.ObjectId('678df3efb618f5141202a196');
    const practId1 = mongoose.Types.ObjectId('a78df3efb618f5141202a196');
    const practId2 = mongoose.Types.ObjectId('b78df3efb618f5141202a196');
    const practId3 = mongoose.Types.ObjectId('c78df3efb618f5141202a196');
    ...
    const patientId1 = mongoose.Types.ObjectId('d78df3efb618f5141202a196');
    const patientId2 = mongoose.Types.ObjectId('e78df3efb618f5141202a196');
    const patientId3 = mongoose.Types.ObjectId('aa8df3efb618f5141202a196');
  ...
  static getPatientNameFromId(req, res, next) {
    try {
